...
用法：
    python3 project/honda27m-appstore-tools/screenshot/fix_keyboard.py            # 诊断并自动修复（默认）
    python3 project/honda27m-appstore-tools/screenshot/fix_keyboard.py status     # 只查看状态，不做修改
    python3 project/honda27m-appstore-tools/screenshot/fix_keyboard.py restore    # 只执行修复
    python3 project/honda27m-appstore-tools/screenshot/fix_keyboard.py test       # 修复后拉起搜索页验证键盘弹出
可选：
