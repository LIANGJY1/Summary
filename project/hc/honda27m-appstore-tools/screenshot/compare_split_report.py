...
可选覆盖（不影响截图脚本配置）：
    python3 project/honda27m-appstore-tools/screenshot/compare_split_report.py --variant zh_day_split
    python3 project/honda27m-appstore-tools/screenshot/compare_split_report.py --ref-dir <UI图目录> --actual-dir <实机图目录> --out <html路径>
"""
